...
let AddSongToPlaylistService = class AddSongToPlaylistService {
    constructor() {
...
let AudioUploadService = class AudioUploadService {
    constructor(http) {
        this.http = http;
    }
    uploadSong(formData) {
...
AudioUploadService.ctorParameters = () => [
...
let SongListComponent = class SongListComponent {
    constructor(songService, addSongToPlaylistService, playingQueueService, userService) {
...
let SongRoutingModule = class SongRoutingModule {
};
...
let UploadSongComponent = class UploadSongComponent {
    constructor(audioUploadService, fb) {
    ...
    upload() {
        ...
        this.audioUploadService.uploadSong(this.formData).subscribe((event) => {
...
UploadSongComponent.ctorParameters = () => [
