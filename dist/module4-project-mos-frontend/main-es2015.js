...
const routes = [
    { path: '', loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./user/user.module */ "./src/app/user/user.module.ts")).then(mod => mod.UserModule) },
    { path: 'admin', loadChildren: () => __webpack_require__.e(/*! import() | admin-admin-module */ "admin-admin-module").then(__webpack_require__.bind(null, /*! ./admin/admin.module */ "./src/app/admin/admin.module.ts")).then(mod => mod.AdminModule) },
    { path: '**', redirectTo: '' }
];
...
// @ts-ignore
let AppRootModule = class AppRootModule {
};
...
let PlayingQueueService = class PlayingQueueService {
...
PlayingQueueService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
...
let HomeComponent = class HomeComponent {
    ...
    ngOnInit() {
        this.loading = true;
        this.userService.getProfile().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])()).subscribe(user => {
            this.loading = false;
            this.user = user;
        });
    }
...
let LoginComponent = class LoginComponent {
    ...
    onSubmit() {
        ...
        this.authService.login(this.f.username.value, this.f.password.value)
            ...
            .subscribe(data => {
            this.userService.getProfile().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])()).subscribe(user => {
...
let UpdateProfileComponent = class UpdateProfileComponent {
    ...
    onSubmit() {
        ...
        this.userService.updateProfile(this.updateForm.value, this.currentUser.id).subscribe((event) => {
...
const routes = [
    ...
    },
    {
        path: '', component: _user_user_component__WEBPACK_IMPORTED_MODULE_6__["UserComponent"], children: [
            ...
            { path: 'song', loadChildren: () => __webpack_require__.e(/*! import() | song-song-module */ "song-song-module").then(__webpack_require__.bind(null, /*! ../song/song.module */ "./src/app/song/song.module.ts")).then(mod => mod.SongModule) },
        ]
    }
];
...
let UserComponent = class UserComponent {
    constructor(router, authService, playingQueueService) {
        this.router = router;
        this.authService = authService;
